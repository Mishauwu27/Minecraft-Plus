...
public class PlusModelProvider extends FabricModelProvider {
    public PlusModelProvider(FabricDataOutput output) { super(output); }
    ...
    public void generateItemModels(ItemModelGenerator itemModelGenerator) {
        ...
        itemModelGenerator.register(PlusItems.ENCHANTED_GOLDEN_CARROT, Items.GOLDEN_CARROT, Models.GENERATED);
        ...
        itemModelGenerator.register(PlusItems.ENCHANTED_GOLDEN_BAKED_POTATO, PlusItems.GOLDEN_BAKED_POTATO, Models.GENERATED);
        ...
        itemModelGenerator.register(PlusItems.BLACKCOBBLE, Models.GENERATED);
    }
}
